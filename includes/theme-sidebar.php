...
/*register_sidebar(array(
  'name' => __( 'Left Home Page Sidebar' ),
  'id' => 'left-home-sidebar',
  'description' => __( 'Widgets in this area will appear on the' ),
  'before_title' => '<div id="widget-title">',
  'after_title' => '</div>'
));
*/
register_sidebar(array(
  'name' => __( 'Right Home Page Sidebar' ),
  'id' => 'right-home-sidebar',
  'description' => __( 'Widgets in this area will on the right hand section of the home page' ),
  'before_title' => '<div id="widget-title">',
  'after_title' => '</div>'
));
